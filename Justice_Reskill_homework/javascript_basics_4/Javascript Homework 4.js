...
for (var key in phoneBook) {
    if (phoneBook[key] === "333-333-3333") {
        console.log(key + " matches 333-333-3333");
    }
}

// 20210218192049
// https://files.slack.com/files-pri/T015H4X4DBM-F01NMSR1H5Y/products.json
const json = {
...
var count = 0;
if (json.kind === "shopping#product") {
    count += 1;
    console.log(key + " matches shopping#product");
}
console.log("a. " + json.currentItemCount);
